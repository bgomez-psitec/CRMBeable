"""
Django settings for crmgestora project.
...
WSGI_APPLICATION = 'crmgestora.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='crmgestora'),
        'USER': env('DB_USER', default='DataContaBL'),
...
# --- Microsoft Graph (Outlook) - fase posterior, ver HANDOFF.md sección 06 ---
...
# --- Auth0 - fase posterior, ver HANDOFF.md sección 03 ---
